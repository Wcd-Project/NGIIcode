...
def main():
    ...
    parser.add_argument('--data_path', default='/home/csl/DatasetsPy2/data',
    ...
    parser.add_argument('--logger_name', default='./runs/f30k_precomp/',
                        help='Path to save Tensorboard log.')
    parser.add_argument('--model_name', default='./runs/f30k_precomp/',
